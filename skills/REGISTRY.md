...
| `benchmarking-against-industry` | Promises external comparators neither source holds; declines and redirects | ihardjo | 1 | `computing-target-adherence` | not yet evaluated — task 5.4 |
